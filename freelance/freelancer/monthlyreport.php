...
<div class="logo">
  ...
  <div class="container" style="width:70%;margin-left:15%;margin-bottom: 5%;" >
  <div class="row">
  ...
  From:<input type="date" name="fromdate" class="form-control" required> To:<input type="date" name="todate" class="form-control" required><br>
