		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-8 col-md-push-6 col-sm-6 col-sm-push-6"style="margin-left: -395px;margin-top: -143px;">
					<form action="workreqaction.php?freelancerid=<?php echo $freelancerid;?>" method="post" id="form-wrap">
						<div class="row form-group">
							<div class="col-md-12">
								<label for="name">Work Title</label>
								<input type="text" class="form-control" id="name" name="worktittle">
							</div>
							</div>
						<div class="row form-group">
							<div class="col-md-12">
				  ...
				  <label class="form-label" for="form3Example1m1">Expected Date</label>
