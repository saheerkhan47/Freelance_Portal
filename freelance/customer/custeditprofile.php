    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-12">
        <div class="card card-registration card-registration-2" style="border-radius: 15px;">
          ...
          <form action="custeditproaction.php" method="post" enctype="multipart/form-data">
            <div class="row g-0">
              <div class="col-lg-6">
...
$s=1;
                ?>
                  ...
                  <div class="column">
                    ...
                    Name<input type="text" id="form3Examplea2" name="name" class="form-control form-control-lg" value="<?php echo $display["username"];?>">
                    ...
                    <div class="col-md-6 mb-4 pb-2">
                      ...
                      <div class="form-outline">
                      Contact<input type="text" id="form3Examplea2" name="contact" class="form-control form-control-lg" value=<?php echo $display["contact"];?>>
                    ...
                    Email<input type="text" id="form3Examplea2" name="email" class="form-control form-control-lg" value=<?php echo $display["email"];?>>
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-4 pb-2 mb-md-0 pb-md-0">
                     ...
                     <a href="custeditproaction.php?userid=<?php echo $display["userid"];?>">
              ...
              <div class="col-lg-6 bg-indigo text-white">
                <div class="p-5">
                  ...
                  <div class="mb-4 pb-2">
                    ...
                    Choose District<select class="form-control" name="ddldistrict" id="ddldistrict">
                  ...
                  <div class="form-group">
                  Choose Location<select class="form-control" name="ddllocation" id="ddllocation" >
