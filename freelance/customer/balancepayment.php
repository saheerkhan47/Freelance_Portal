...
$sql = "select * from tblpayment where requestid='$requestid' and paymentstatus='Advancepayment completed'";
...
<form action="balancepayaction.php" method="post">
              ...
              <div class="row mt-3 mb-3">
                ...
                <div class="col-md-6">
                  ...
                  <div class="input">
                    ...
                    <i class="fa fa-calendar"></i>
                    <input type="text" class="form-control" required pattern="[0-9]{3}" minlength="3" maxlength="3"  placeholder="cvv" required>
  ...
  <div class="col-md-6">
      ...
      <div class="card">
        ...
        <div class="d-flex justify-content-between p-3">
          ...
          <div class="mt-1">
            <sup class="super-price"><?php echo $display['balanceamount'] ?></sup>
