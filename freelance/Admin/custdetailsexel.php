...
<head>
<meta charset="utf-8">
<title>Musicband Management</title>
</head>

<body>
<form action="Excel/excel_cust.php" method="post">
<div class="logo">
              <a href="./index.php">
                <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
...
$sql ="SELECT count(*) as custcount,username,contact,email FROM tbluser group by userid";
