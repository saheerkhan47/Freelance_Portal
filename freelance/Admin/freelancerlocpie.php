...
$sql ="SELECT count(*) as Categorycount,locationname FROM tblfreelancerreg f inner join tbllocation c on f.locationid=c.locationid  group by f.locationid";
 ...
 <html>  
      ...
      <body>  
           ...
           <div style="width:900px; margin-top:6%"><br>  
                <h3 align="center">Pie Chart showing the Count Location wise Freelancers </h3>  
                <br />  
